    ...
    choices: [
      {
        message: {
          content:
            '{"stem":"Q1","reference":"A1","bloom":"Remember","tier":1,"explanation":"E1"}',
        },
      },
    ],
  });
      ...
      choices: [
        {
          message: {
            content:
              '{"stem":"Q3","reference":"A3","bloom":"Apply","tier":3,"explanation":"E3"}',
          },
        },
      ],
    })
      ...
      choices: [
        {
          message: {
            content:
              '{"stem":"Q5","reference":"A5","bloom":"Evaluate","tier":5,"explanation":"E5"}',
          },
        },
      ],
    });

  const items = await generateTieredItems('Sample', 'ctx', [
    'Remember',
    'Apply',
    'Evaluate',
  ]);
